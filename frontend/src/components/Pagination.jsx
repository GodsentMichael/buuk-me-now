...
const Pagination = ({ totalPages, currentPage, onPageChange }) => {
  ...
  return (
    <div className="flex gap-2 items-center">
      ...
      >
        <img src="https://res.cloudinary.com/dye76dtzn/image/upload/v1709289410/arrow-left_xvbw7l.png" alt="Left Arrow" className="h-7 w-7" /> 
      </div>
      ...
      >
        <img src="https://res.cloudinary.com/dye76dtzn/image/upload/v1709289393/arrow_i132xl.png" alt="Right Arrow" className="h-7 w-7" /> 
      </div>
    </div>
  );
};
